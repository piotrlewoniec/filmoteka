...
var _movieList = require("./js/movie-list");
var _createPagination = require("./js/createPagination");
var _footer = require("./js/footer");

},{"./sass/main.scss":"dFl68","./js/footer":"fXl6u","./js/createPagination":"jDcF3","./js/movie-list":"aK8GK"}],"dFl68":[function() {},{}],"fXl6u":[function(require,module,exports) {
(()=>{
    const refs = {
...
},{}],"jDcF3":[function(require,module,exports) {
...
function fetchMovies(page) {
    ...
    (0, _notiflixDefault.default).Loading.pulse("Pobieranie film\xf3w...");
    (0, _axiosDefault.default).get("https://api.themoviedb.org/3/movie/changes", {
        params: {
            page: page,
        ...
        (0, _notiflixDefault.default).Notify.failure("Wystąpił błąd podczas pobierania film\xf3w");
...
function renderPaginationButtons() {
    ...
    if (endPage - startPage < visibleButtons - 1) startPage = Math.max(endPage - visibleButtons + 1, 1);
    paginationContainer.appendChild(createNavigationButton("<", currentPage - 1, currentPage > 1, currentPage !== 1, "btn-arrow"));
    if (startPage > 1) {
    ...
    paginationContainer.appendChild(createNavigationButton(">", currentPage + 1, currentPage < totalPages, currentPage !== totalPages, "btn-arrow"));
    ...
    if (buttonLast) buttonLast.addEventListener("click", function() {
        if (currentPage !== totalPages) fetchMovies(totalPages);
    });
}
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var Buffer = require("b0d4228fd880a60c").Buffer;
"use strict";
/**
...
},{"b0d4228fd880a60c":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("f2dacb1d18cc3b0a");
var ieee754 = require("bb1bb64d0252ad3a");
...
},{"f2dacb1d18cc3b0a":"eIiSV","bb1bb64d0252ad3a":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{}],"aK8GK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
async function fetchPopularMovies() {
    return (0, _axiosDefault.default).get("https://api.themoviedb.org/3/trending/movie/day?language=en-US", config);
}
async function fetchGenres() {
    const genres = await (0, _axiosDefault.default).get("https://api.themoviedb.org/3/genre/movie/list?language=e", config);
    return new Map(genres.data.genres.map((genre)=>[
            genre.id,
            genre.name
        ]));
}
async function renderMovieList(movieList) {
    ...
    const markup = movieList.map((movie)=>{
     ...
     <ul class="movie-card__info">
       ...
       <li class="movie-card__genre">${getGenresNamesAndYear(genres, movie.genre_ids, movie.release_date)}</li>
     </ul>
    </div>
      `;
    }).join(" ");
...
function getGenresNames(genres, genre_ids) {
    ...
    } else filteredGenres = genresList;
    return filteredGenres.join(", ");
}
function renderMoviePlaceholders() {
    const placeholders = [];
    for(let i = 0; i < 20; i++)placeholders.push(`<div class="movie-card--placeholder">
      <h3 class="movie-card--placeholder__title">Movie Poster Placeholder</h3>
    </div>`);
    movieListContainer.innerHTML = placeholders.join(" ");
}

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequired76b")
